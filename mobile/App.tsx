...
const styles = StyleSheet.create({
  ...
  reviewTitle: { color: colors.linen, fontFamily: fonts.bodyBold, fontSize: 16, letterSpacing: -0.2 },
  reviewSub: { color: colors.linen, fontFamily: fonts.body, fontSize: 14, opacity: 0.78 },
  toast: {
    position: "absolute",
    left: 24,
    right: 24,
